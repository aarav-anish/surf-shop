...
- Add your mapbox token to the .env file (if you haven't already) as MAPBOX_TOKEN
- Update Post Model (/models/post.js)

```JS
/*
	Remove coordinates: Array, field
...
- Add Index Controller (/controllers/index.js)
...
- Update Index Routes (/routes/index.js)

```JS
/*
	Add landingPage method to the destructure object for the Index controller
...
- Update Post Show Client JS File (/public/javascripts/post-show.js)

```JS
/*
	Replace both instances of post.coordinates with post.geometry.coordinates
*/
...
- Update Main Styleheet (/public/stylesheets/style.css)
...
- Update the header to include mapbox CDN's (/views/partials/header.ejs)
...
<html lang="en" dir="ltr">
  ...
  <body>
    <%- include('./navbar') -%>
    <div class="container bodyPageWrapper">
      <%- include('./flash-messages') -%>
```

- Update landing page view to include clustered map with all posts (/views/index.ejs)
...
<script>
  let posts = {features: <%- JSON.stringify(posts) %>}
...
- Update Posts Controller (/controllers/posts.js)

```JS
// Add mapBoxToken to top of file
const mapboxToken = process.env.MAPBOX_TOKEN;
/*
	Update the postIndex's res.render() method
	inside of the module.exports object..
*/
...
- Update posts index view to include clustered map with paginated posts (/views/posts/index.ejs)
...
- Create a new JS file named allPostsClusterMap.js in /public/javascripts
...
- Create cities.js file (see next step), once that's done then uncomment the seed function in app.js and run your node server one time, then comment it back out and restart the node server again. Your database should now be seeded. Preview the app to see if it all works.

```JS
/*
	Seed function in app.js
*/
const { seedPosts } = require('./seeds');
seedPosts();
```

- Create cities.js in the project's root directory
